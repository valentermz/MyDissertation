...
We know from Poincaré that a \emph{hyperbolic} singularity of a planar vector field is analytically linearizable (since in dimension two a hyperbolic spectrum always lies on the Poincar\'{e} domain). Analytic invariance of the index implies that the index cannot depend on anything but the spectra.
...
\nocite{Mathematica9,Macaulay2,CoCOA-5,CoCoALib}
